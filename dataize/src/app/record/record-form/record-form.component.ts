...
export class RecordFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.excelService.getFileName('record');
  ...
  onCreateFileDialog() {
    ...
    dialRef.afterClosed().subscribe(data => {
      ...
      let createProm = new Promise(() => {
        this.excelService.createFile('record', this.fileName);
      });
      createProm.then(() => this.excelService.getFileName('record'));
    });
  }
  ...
  onOpenFileDialog() {
    ...
    dialRef.afterClosed().subscribe(data => {
      if (data) {
        ...
        openProm.then(() => this.excelService.getFileName('record'))
      }
    });
  }
